...
// innercare-1 専用のリダイレクトURL（固定）
const REDIRECT_URL = 'https://sf-system.jp/link.php?i=pi6e55wt4f78&m=mi41ruivpeep';

// デバッグログ
console.log('[INNER CARE - innercare-1] リダイレクト先URL:', REDIRECT_URL);
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    // リダイレクト実行
                    console.log('[INNER CARE - innercare-1] 最終リダイレクト実行:', REDIRECT_URL);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (productLink) {
        productLink.href = REDIRECT_URL;
        console.log('[INNER CARE - innercare-1] 商品リンクを設定:', productLink.href);
    }
